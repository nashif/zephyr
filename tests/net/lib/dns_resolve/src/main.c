...
void test_main(void)
{
	ztest_test_suite(dns_tests,
			 ...
			 ztest_unit_test(test_test_dns_query_invalid_timeout),
			 ztest_unit_test(test_test_dns_query_invalid_context),
			 ztest_unit_test(test_test_dns_query_invalid_callback),
			 ztest_unit_test(test_test_dns_query_invalid_query),
			 ztest_unit_test(test_test_dns_query_too_many),
			 ztest_unit_test(test_test_dns_query_server_count),
			 ztest_unit_test(test_test_dns_query_ipv4_server_count),
			 ztest_unit_test(test_test_dns_query_ipv6_server_count),
			 ztest_unit_test(test_test_dns_query_ipv4_timeout),
			 ztest_unit_test(test_test_dns_query_ipv6_timeout),
			 ztest_unit_test(test_test_dns_query_ipv4_cancel),
			 ztest_unit_test(test_test_dns_query_ipv6_cancel),
			 ztest_unit_test(test_test_dns_query_ipv4),
			 ztest_unit_test(test_test_dns_query_ipv4_numeric));
