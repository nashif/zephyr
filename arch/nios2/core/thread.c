 ...
 * to k_priv_thread_entry() since this arch puts the first four arguments
 * in r4-r7 and not on the stack
 */
void k_priv_thread_entry_wrapper(k_thread_entry_t, void *, void *, void *);

struct init_stack_frame {
	/* top of the stack / most recently pushed */

	/* Used by k_priv_thread_entry_wrapper. pulls these off the stack and
	 * into argument registers before calling k_priv_thread_entry()
	 */
		     ...
		     void *arg1, void *arg2, void *arg3)
{
	...
	thread->callee_saved.ra = (uint32_t)k_priv_thread_entry_wrapper;
