...
#define PHYS_RAM_ADDR    CONFIG_PHYS_SRAM_ADDR

/* physical address where the kernel is loaded */
#ifdef CONFIG_XIP
  #define PHYS_LOAD_ADDR   CONFIG_PHYS_LOAD_ADDR
#else  /* !CONFIG_XIP */
  #define PHYS_LOAD_ADDR   CONFIG_PHYS_SRAM_ADDR
#endif /* CONFIG_XIP */
...
MEMORY
    {
#ifdef CONFIG_XIP
    ROM (rx)        : ORIGIN = PHYS_LOAD_ADDR, LENGTH = 32K
    RAM (wx)        : ORIGIN = PHYS_RAM_ADDR, LENGTH = 8K
#else  /* !CONFIG_XIP */
    RAM (wx)	    : ORIGIN = PHYS_LOAD_ADDR, LENGTH = 8K
#endif /* CONFIG_XIP */
