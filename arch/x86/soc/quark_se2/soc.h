...
#define SYSCLK_DEFAULT_IOSC_HZ MHZ(CONFIG_SYS_CLOCK_HW_CYCLES_PER_SEC / 1000000)
...
/* TODO:>> ENTRY block of defines to be updated for Quark SE2 */

#ifndef _ASMLANGUAGE

/* Update SoC definitions for this OS driver support */
/* Core system registers */

struct scss_ccu {
	/**< Hybrid Oscillator Configuration 0 */
	volatile uint32_t osc0_cfg0;
	/**< Hybrid Oscillator status 1 */
	volatile uint32_t osc0_stat1;
	/**< Hybrid Oscillator configuration 1 */
	volatile uint32_t osc0_cfg1;
	/**< RTC Oscillator status 0 */
	volatile uint32_t osc1_stat0;
	/**< RTC Oscillator Configuration 0 */
	volatile uint32_t osc1_cfg0;
	/**< USB Phase lock look configuration */
	volatile uint32_t usb_pll_cfg0;
	/**< Peripheral Clock Gate Control */
	volatile uint32_t ccu_periph_clk_gate_ctl;
	/**< Peripheral Clock Divider Control 0 */
	volatile uint32_t ccu_periph_clk_div_ctl0;
	/**< Peripheral Clock Divider Control 1 */
	volatile uint32_t ccu_gpio_db_clk_ctl;
	/**< External Clock Control Register */
	volatile uint32_t ccu_ext_clock_ctl;
	/**< Sensor subsustem peripheral clock gate control */
	volatile uint32_t ccu_ss_periph_clk_gate_ctl;
	/**< System Low Power Clock Control */
	volatile uint32_t ccu_lp_clk_ctl;
	volatile uint32_t reserved;
	/**< AHB Control Register */
	volatile uint32_t ccu_mlayer_ahb_ctl;
	/**< System Clock Control Register */
	volatile uint32_t ccu_sys_clk_ctl;
	/**< Clocks Lock Register */
	volatile uint32_t osc_lock_0;
};

struct scss_peripheral {
	/**< USB Configuration */
	volatile uint32_t usb_phy_cfg0;
	/**< Peripheral Configuration */
	volatile uint32_t periph_cfg0;
...
#define UART_NS16550_PORT_0_INT_OFFSET			0x00e4
...
#define UART_NS16550_PORT_1_INT_OFFSET			0x0158
...
/* TODO:<< EXIT block of defines to be updated for Quark SE2 */
