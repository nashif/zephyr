...
.macro _store_old_thread_callee_regs
	...
	/* Save old thread into switch handle which is required by k_priv_sched_switch_spin.
	 ...
	 * in k_priv_sched_switch_spin in case of SMP. Though it's not likely that this issue
