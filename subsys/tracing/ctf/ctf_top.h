...
typedef enum {
	...
	CTF_EVENT_SEMAPHORE_GIVE	=  0x22,
	CTF_EVENT_SEMAPHORE_TAKE	=  0x23,
	CTF_EVENT_MUTEX_INIT		=  0x24,
	CTF_EVENT_MUTEX_LOCK		=  0x25,
	CTF_EVENT_MUTEX_UNLOCK		=  0x26,
	CTF_EVENT_EVFLAG_INIT		=  0x27,
	CTF_EVENT_EVFLAG_SET		=  0x28,
	CTF_EVENT_EVFLAG_WAIT		=  0x29,
} ctf_event_t;
