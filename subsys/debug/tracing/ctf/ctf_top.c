...
static ctf_bounded_string_t get_thread_name(struct k_thread *thread)
{
...
void sys_trace_thread_switched_out(void)
{
	...
	ctf_bounded_string_t name = get_thread_name(thread);

	ctf_top_thread_switched_out((u32_t)(uintptr_t)thread, name);
}
...
void sys_trace_thread_switched_in(void)
{
	...
	ctf_top_thread_switched_in((u32_t)(uintptr_t)thread, name);
}
...
void sys_trace_thread_abort(struct k_thread *thread)
{
	...
	ctf_top_thread_abort((u32_t)(uintptr_t)thread, name);
}
...
void sys_trace_thread_suspend(struct k_thread *thread)
{
	...
	ctf_top_thread_suspend((u32_t)(uintptr_t)thread, name);
}
...
void sys_trace_thread_resume(struct k_thread *thread)
{
	...
	ctf_top_thread_resume((u32_t)(uintptr_t)thread, name);
}
...
void sys_trace_thread_ready(struct k_thread *thread)
{
	...
	ctf_top_thread_ready((u32_t)(uintptr_t)thread, name);
}
...
void sys_trace_thread_pend(struct k_thread *thread)
{
	...
	ctf_top_thread_pend((u32_t)(uintptr_t)thread, name);
}
