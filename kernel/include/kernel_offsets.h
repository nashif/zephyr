...
GEN_ABSOLUTE_SYM(__z_interrupt_stack_SIZEOF, sizeof(k_priv_interrupt_stacks[0]));
GEN_ABSOLUTE_SYM(__z_interrupt_all_stacks_SIZEOF, sizeof(k_priv_interrupt_stacks));
