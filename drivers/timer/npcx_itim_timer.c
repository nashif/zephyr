...
/* Announced cycles in system timer before executing clock_announce() */
...
uint32_t clock_elapsed(void)
{
	...
	/* Return how many ticks elapsed since last clock_announce() call */
