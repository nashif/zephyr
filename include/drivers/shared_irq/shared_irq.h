...
#ifndef ZEPHYR_INCLUDE_DRIVERS_SHARED_IRQ_SHARED_IRQ_H_
#define ZEPHYR_INCLUDE_DRIVERS_SHARED_IRQ_SHARED_IRQ_H_
...
#endif /* ZEPHYR_INCLUDE_DRIVERS_SHARED_IRQ_SHARED_IRQ_H_ */
