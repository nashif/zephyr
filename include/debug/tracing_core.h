...
/**
 * @brief Try to handle one packet added to tracing list to
 *        get free space in tracing packet pool. And it will
 *        tell caller if more packet is in tracing list after
 *        this free.
 *
...
/**
 * @brief Check if is in tracing thread context.
 *
